...
var _bcardiff$elm_debounce$Helpers$deferredCmd = F2(
	function (delay, a) {
		return A2(
			_elm_lang$core$Task$perform,
...
var _bcardiff$elm_debounce$Debounce$performMessage = function (msg) {
	return A2(
		_elm_lang$core$Task$perform,
		_elm_lang$core$Basics$always(msg),
		_elm_lang$core$Task$succeed(_elm_lang$core$Basics$never));
};
var _bcardiff$elm_debounce$Debounce$unreachable = function (_p0) {
...
var _bcardiff$elm_debounce$Debounce$incarnation = function (_p1) {
	var _p2 = _p1;
	return _p2._0;
};
var _bcardiff$elm_debounce$Debounce$Config = F4(
	function (a, b, c, d) {
		return {ctor: 'Config', _0: a, _1: b, _2: c, _3: d};
	});
var _bcardiff$elm_debounce$Debounce$config = F4(
	function (getState, updateState, msg, delay) {
		return A4(_bcardiff$elm_debounce$Debounce$Config, getState, updateState, msg, delay);
	});
var _bcardiff$elm_debounce$Debounce$State = function (a) {
	return {ctor: 'State', _0: a};
};
var _bcardiff$elm_debounce$Debounce$init = _bcardiff$elm_debounce$Debounce$State(0);
var _bcardiff$elm_debounce$Debounce$setIncarnation = F2(
	function (_p3, i) {
		var _p4 = _p3;
		return _bcardiff$elm_debounce$Debounce$State(i);
	});
var _bcardiff$elm_debounce$Debounce$Deferred = F2(
	function (a, b) {
		return {ctor: 'Deferred', _0: a, _1: b};
	});
var _bcardiff$elm_debounce$Debounce$update = F3(
	function (_p5, deb_msg, model) {
		var _p6 = _p5;
		var _p8 = _p6._0;
		var _p7 = deb_msg;
		if (_p7.ctor === 'Raw') {
			var oldState = _p8(model);
			var newIncarnation = _bcardiff$elm_debounce$Debounce$incarnation(oldState) + 1;
			return {
				ctor: '_Tuple2',
				_0: A2(
					_p6._1,
					model,
					A2(_bcardiff$elm_debounce$Debounce$setIncarnation, oldState, newIncarnation)),
				_1: A2(
					_bcardiff$elm_debounce$Helpers$deferredCmd,
					_p6._3,
					_p6._2(
						A2(_bcardiff$elm_debounce$Debounce$Deferred, newIncarnation, _p7._0)))
			};
		} else {
			var validIncarnation = _elm_lang$core$Native_Utils.eq(
				_bcardiff$elm_debounce$Debounce$incarnation(
					_p8(model)),
				_p7._0);
			return {
				ctor: '_Tuple2',
				_0: model,
				_1: validIncarnation ? _bcardiff$elm_debounce$Debounce$performMessage(_p7._1) : _elm_lang$core$Platform_Cmd$none
			};
		}
	});
var _bcardiff$elm_debounce$Debounce$Raw = function (a) {
	return {ctor: 'Raw', _0: a};
};
var _bcardiff$elm_debounce$Debounce$debounce = F2(
	function (_p9, raw_msg) {
		var _p10 = _p9;
		return _p10._2(
			_bcardiff$elm_debounce$Debounce$Raw(raw_msg));
	});
var _bcardiff$elm_debounce$Debounce$debounceCmd = F2(
	function (cfg, msg) {
		return _bcardiff$elm_debounce$Debounce$performMessage(
			A2(_bcardiff$elm_debounce$Debounce$debounce, cfg, msg));
	});
var _bcardiff$elm_debounce$Debounce$debounce1 = F3(
	function (_p11, raw_msg, a) {
		var _p12 = _p11;
		return _p12._2(
			_bcardiff$elm_debounce$Debounce$Raw(
				raw_msg(a)));
	});
...
var _user$project$Quipper$isRecursive = function (output) {
	var _p0 = output;
	if (_p0.ctor === 'Recursive') {
		return true;
	} else {
		return false;
	}
};
var _user$project$Quipper$qtupleType = function (n) {
	var _p1 = n;
	if (_p1 === 1) {
		return 'Qubit';
	} else {
		return A2(
			...
			A2(
				...
				A2(
					_elm_lang$core$String$join,
					', ',
					A2(_elm_lang$core$List$repeat, n, 'Qubit')),
				')'));
	}
};
var _user$project$Quipper$signature = function (model) {
	var out = function () {
		var _p2 = model.output;
		if (_p2.ctor === 'Recursive') {
			return 'RecAction';
		} else {
			return _user$project$Quipper$qtupleType(_p2._0);
		}
	}();
	var in_ = _user$project$Quipper$qtupleType(model.input);
	return A2(
		_elm_lang$core$Basics_ops['++'],
		in_,
		A2(_elm_lang$core$Basics_ops['++'], ' -> Circ ', out));
};
var _user$project$Quipper$qtuple = function (n) {
	var _p3 = n;
	if (_p3 === 1) {
		return 'q';
	} else {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				A2(_elm_lang$core$String$join, ', ', qs),
				')'));
	}
};
var _user$project$Quipper$code = function (model) {
	return A2(
		_elm_lang$core$String$join,
		'\n',
		{
			...
			_0: A2(
				...
				A2(
					_elm_lang$core$Basics_ops['++'],
					' :: ',
					_user$project$Quipper$signature(model))),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$core$Basics_ops['++'],
...
var _user$project$Quipper$monospaced = _elm_lang$html$Html_Attributes$style(
	{
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'font-family', _1: 'Fira Code, monospace'},
		_1: {
			ctor: '::',
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'name',
					_1: _elm_lang$core$Json_Encode$string(model.functionName)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: {
							...
							_0: {
								...
								_1: _elm_lang$core$Json_Encode$bool(
									_user$project$Quipper$isRecursive(model.output))
							},
							_1: {
								ctor: '::',
								_0: {
...
var _user$project$Quipper$debounceCfg = A4(
	_bcardiff$elm_debounce$Debounce$config,
	function (_) {
		return _.debounceState;
	},
	F2(
		function (model, s) {
			return _elm_lang$core$Native_Utils.update(
	...
	_user$project$Quipper$Deb,
	500);
var _user$project$Quipper$debCmd = _bcardiff$elm_debounce$Debounce$debounceCmd(_user$project$Quipper$debounceCfg);
var _user$project$Quipper$update = F3(
	function (_p7, msg, model) {
		var _p8 = _p7;
		var _p12 = _p8._1;
		var _p11 = _p8._2;
		var trans = function (qmodel_) {
			var cmd = A2(
				_elm_lang$core$Platform_Cmd$map,
				_p11,
				_user$project$Quipper$debCmd(_user$project$Quipper$Transform));
			return {
				ctor: '_Tuple2',
				_0: A2(_p12, model, qmodel_),
				_1: cmd
			};
		};
		var qmodel = _p8._0(model);
		var _p9 = msg;
		switch (_p9.ctor) {
			case 'Code':
				return trans(
			...
			case 'Deb':
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_p12, model, qmodel_),
					_1: A2(_elm_lang$core$Platform_Cmd$map, _p11, cmd)
				};
			default:
				return {
					ctor: '_Tuple2',
					...
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_p8._3,
						_user$project$Quipper$transformCmd(qmodel))
				};
		}
	});
...
var _user$project$Quipper$kindRow = function (model) {
	...
	var kinds = {
		ctor: '::',
		_0: _user$project$Quipper$Symbolic,
		_1: {
			ctor: '::',
			_0: _user$project$Quipper$Numeric,
			_1: {ctor: '[]'}
		}
	};
	return A2(
		...
		A2(
			...
			'kind',
			A2(_elm_lang$core$List$map, kindToRadio, kinds)));
};
var _user$project$Quipper$Output = function (a) {
	return {ctor: 'Output', _0: a};
};
var _user$project$Quipper$recursiveRow = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Form_Checkbox$checkbox,
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Checkbox$checked(
				_user$project$Quipper$isRecursive(model.output)),
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Form_Checkbox$onCheck(
					function (c) {
						return _user$project$Quipper$Output(
							c ? _user$project$Quipper$Recursive : _user$project$Quipper$Qubits(0));
					}),
				_1: {ctor: '[]'}
			}
		},
...
var _user$project$Quipper$outputRow = function (model) {
	var $int = function () {
		var _p13 = model.output;
		if (_p13.ctor === 'Recursive') {
			return 0;
		} else {
			return _p13._0;
		}
	}();
	return _rundis$elm_bootstrap$Bootstrap_Form_Input$number(
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
				function (_p14) {
					return _user$project$Quipper$Output(
						_user$project$Quipper$Qubits(
							A2(
...
var _user$project$Quipper$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _user$project$Quipper$inputRow = function (model) {
	return _rundis$elm_bootstrap$Bootstrap_Form_Input$number(
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(
				function (_p15) {
					return _user$project$Quipper$Input(
						A2(
							_elm_lang$core$Result$withDefault,
							model.input,
			...
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(
					_elm_lang$core$Basics$toString(model.input)),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Quipper$FunctionName = function (a) {
	return {ctor: 'FunctionName', _0: a};
};
var _user$project$Quipper$nameRow = function (model) {
	return _rundis$elm_bootstrap$Bootstrap_Form_Input$text(
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$value(model.functionName),
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$onInput(_user$project$Quipper$FunctionName),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Quipper$Code = function (a) {
	return {ctor: 'Code', _0: a};
};
var _user$project$Quipper$bodyRow = function (model) {
	return _rundis$elm_bootstrap$Bootstrap_Form_Textarea$textarea(
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$value(model.code),
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$onInput(_user$project$Quipper$Code),
				_1: {
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$rows(10),
					_1: {
...
var _user$project$Quipper$view = F2(
	function (_p16, model) {
		var _p17 = _p16;
		var _p21 = _p17._0;
		var rowsTail = {
		...
		var rowsMid = function () {
			var _p18 = _p21(model).output;
			if (_p18.ctor === 'Recursive') {
				return {ctor: '[]'};
			} else {
				return {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Output qubits', _1: _user$project$Quipper$outputRow},
					_1: {ctor: '[]'}
				};
			}
		}();
		var rowsHead = {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'Recursive', _1: _user$project$Quipper$recursiveRow},
					_1: {ctor: '[]'}
				}
			}
		};
		var rows = A2(
			_elm_lang$core$Basics_ops['++'],
			rowsHead,
			A2(_elm_lang$core$Basics_ops['++'], rowsMid, rowsTail));
		return A2(
...
var _user$project$Quipper$Config = F4(
	function (a, b, c, d) {
		return {ctor: 'Config', _0: a, _1: b, _2: c, _3: d};
	});
var _user$project$Quipper$config = F4(
	function (getState, updateState, msg, result) {
		return A4(_user$project$Quipper$Config, getState, updateState, msg, result);
	});

var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Main$codeArea = function (value) {
	return _rundis$elm_bootstrap$Bootstrap_Form_Textarea$textarea(
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$id('code'),
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$disabled,
				_1: {
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$value(value),
					_1: {
						ctor: '::',
						_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$rows(30),
						_1: {
							ctor: '::',
							_0: _rundis$elm_bootstrap$Bootstrap_Form_Textarea$attrs(
								{
...
var _user$project$Main$ShowTree = function (a) {
	return {ctor: 'ShowTree', _0: a};
};
var _user$project$Main$treeCheckbox = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Form_Checkbox$checkbox,
		{
			ctor: '::',
			_0: _rundis$elm_bootstrap$Bootstrap_Form_Checkbox$onCheck(_user$project$Main$ShowTree),
			_1: {
				ctor: '::',
				_0: _rundis$elm_bootstrap$Bootstrap_Form_Checkbox$checked(model.showTree),
				_1: {ctor: '[]'}
			}
		},
		'Show tree');
};
var _user$project$Main$treeView = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Form$form,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_1: {
						ctor: '::',
						_0: _user$project$Main$codeArea(model.tree),
						_1: {ctor: '[]'}
					}
				}),
			_1: {ctor: '[]'}
...
var _user$project$Main$qpmcView = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Form$form,
		{ctor: '[]'},
		{
...
var _user$project$Main$Quipper = function (a) {
	return {ctor: 'Quipper', _0: a};
};
var _user$project$Main$quipperCfg = A4(
	_user$project$Quipper$config,
	function (_) {
	...
	_user$project$Main$Quipper,
	_user$project$Main$TransformResult);
var _user$project$Main$init = function () {
	var _p0 = _user$project$Quipper$init(_user$project$Main$quipperCfg);
	var quipperState = _p0._0;
...
var _user$project$Main$view = function (model) {
	var qpmcCard = {
		...
		width: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: model.showTree ? _rundis$elm_bootstrap$Bootstrap_Grid_Col$lg12 : _rundis$elm_bootstrap$Bootstrap_Grid_Col$lg6,
					_1: {
						ctor: '::',
						_0: model.showTree ? _rundis$elm_bootstrap$Bootstrap_Grid_Col$xl4 : _rundis$elm_bootstrap$Bootstrap_Grid_Col$xl6,
						_1: {ctor: '[]'}
					}
				}
			}
	...
	var treeCard = {
		...
		width: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _rundis$elm_bootstrap$Bootstrap_Grid_Col$xl4,
					_1: {ctor: '[]'}
				}
			}
		},
	...
	var quipperCard = {
		...
		width: {
			...
			_1: {
				ctor: '::',
				_0: model.showTree ? _rundis$elm_bootstrap$Bootstrap_Grid_Col$md6 : _rundis$elm_bootstrap$Bootstrap_Grid_Col$md12,
				_1: {
					ctor: '::',
	...
	var cardDescriptions = model.showTree ? {
		ctor: '::',
		_0: quipperCard,
		_1: {
			ctor: '::',
...
Elm['Quipper'] = Elm['Quipper'] || {};
if (typeof _user$project$Quipper$main !== 'undefined') {
    _user$project$Quipper$main(Elm['Quipper'], 'Quipper', undefined);
}
